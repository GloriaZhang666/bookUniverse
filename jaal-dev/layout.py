...
# MINE
def get_attribute_combination(id, options, label, description):
    """Creates a multi-select (checklist) form with provides details
                ...
                dbc.Col([
                    ...
                    dbc.Form([
                        ...
                        get_attribute_combination(
                            ...
                            label='Select nodes by',
                            description='Select specific nodes by'
                        ),
